...
N -60 90 -40 90 {lab=VINP}
N 80 -80 80 -60 {lab=VDD}
N 50 260 50 280 {lab=VSS}
N 180 90 210 90 {lab=VINN}
...
C {devices/iopin.sym} 50 280 1 0 {name=p1 lab=VSS}
C {devices/opin.sym} 460 40 0 0 {name=p2 lab=VOUT}
C {devices/ipin.sym} 80 -80 1 0 {name=p3 lab=VDD}
C {devices/ipin.sym} -60 90 0 0 {name=p4 lab=VINP}
C {devices/ipin.sym} 210 90 2 0 {name=p5 lab=VINN}
C {devices/gnd.sym} 410 100 0 0 {name=l1 lab=GND}
C {devices/res.sym} -160 60 0 0 {name=R1
value=1k
footprint=1206
device=resistor
m=1}
C {devices/lab_wire.sym} 80 -70 0 0 {name=p6 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 430 40 1 0 {name=p7 sig_type=std_logic lab=VOUT}
C {devices/lab_wire.sym} -50 90 0 0 {name=p8 sig_type=std_logic lab=VINP}
C {devices/lab_wire.sym} 190 90 1 0 {name=p9 sig_type=std_logic lab=VINN}
C {devices/lab_wire.sym} 50 270 0 0 {name=p10 sig_type=std_logic lab=VSS}
